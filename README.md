...
<details>
  ...
  <ol>
    ...
    <li><a href="#how-to-test-and-run-the-draft-notebook">How to Test and Run the Draft Notebook</a></li>
    <li><a href="#how-to-preview-the-final-dashboard">How to Preview the Final Dashboard</a></li>
